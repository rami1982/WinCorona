      ...
      <div>
        ...
        <section className="destenation">
          ...
          <p>
            ...
            correlations within the data and share our findings to medical
            experts worldwide to help find a cure.
          </p>
          <hr />
          <ul className="grid">
            <li
        ...
        <section className="packges">
          ...
          <p>
            ...
            fields, We are formed by our desire to help during this crisis
          </p>
          <hr />
          ...
          <ul className="grid">
            ...
            <li>
              ...
              <p>
                ...
                Ghebreyesus, finally addressed the term to describe the
                outbreak,
                <br />{" "}
                <q>
                  WHO has been assessing this outbreak around the clock and we
                  are deeply concerned both by the alarming levels of spread and
                ...
                <q>
                  ...
                  characterized as a <strong>pandemic</strong>. Pandemic is not
                  a word to use lightly or carelessly,
                </q>{" "}
                he added.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                The virus enters your body via your eyes, nose and/or mouth, so
            ...
            <li>
              ...
              {/* maybe: crawler for updated number */}
              <h4>The Numbers</h4>
              <p>
                <strong>459,994</strong> - affected around the globe
                <br />
                <strong>20,826</strong> - deaths
                <br />
                <strong>113,783</strong> - recovered
                <br />
                <strong>196</strong> - countries and terretories confirmed cases
                <br />
              </p>
            </li>
          </ul>
